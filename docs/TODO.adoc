...
* [x] *[Dinis]* R61: Disponibilizar uma interface em modo texto onde o utilizador possa interagir com a aplicação.
...
* [ ] R57: Acesso restrito por credenciais armazenadas num ficheiro "credenciais_acesso.txt".
